...
== Solution
  ...
  $arrow(u) dot arrow(v) = 1 dot 4 +2 dot (-1)+3 dot 2 =bold(8)$
])
#pagebreak()
...
== Solution
Dot product is defined as $ a dot b =norm(a)norm(b)dot underbrace(cos(theta),angle(a,b)) $
So. $ theta = cos^(-1)((a dot b)/(norm(a)norm(b))) $
